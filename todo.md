...
- [ ] **WP-157: Expand WASM App Ecosystem.** Begin porting standard POSIX and POSIX-adjacent C/C++ libraries and applications into native WASM applications. (In progress: `posix_utils` and `wasm_bridge` stubs created)
