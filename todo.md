...
- [ ] **WP-055: Инфраструктура драйверов видеокарт (DRM/KMS).** Разработать базовую абстракцию подсистемы Direct Rendering Manager и Kernel Mode Setting для управления дисплеями и графическими буферами.
- [ ] **WP-056: Универсальный драйвер Framebuffer (VESA/GOP).** Реализовать базовый драйвер для вывода графики через UEFI GOP или VESA для обеспечения работы графики до загрузки специализированных драйверов.
